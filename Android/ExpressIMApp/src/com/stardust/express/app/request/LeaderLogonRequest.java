 ...
 */
public class LeaderLogonRequest extends BaseRequest {

    private String username;
    private String password;

    public LeaderLogonRequest(Context context, String username,
                              String password,
    ...
    protected String getRequestUrl() {
        return SharedUtil.getString(context, "Host") + Constants.LEADER_LOGON_URL;
    }
